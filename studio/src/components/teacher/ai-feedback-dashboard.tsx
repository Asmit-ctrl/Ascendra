    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: 'Thank you for helping Mwalimu AI learn',
        })
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          ...
          <Badge variant="secondary">Help Mwalimu AI Learn</Badge>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  How you're helping Mwalimu AI learn
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950 p-3 rounded-md text-sm">
                    ...
                    <p className="text-xs">
                      Your feedback is training Mwalimu AI to understand Kenyan students better.
