...
export function tutorIntroMessage(opts: {
  ...
  if (band === 'upper-primary') {
    return `Karibu, ${studentName}! I'm Mwalimu. What part of ${subject} would you like to work on today?`
  }
  return `Karibu, ${studentName}! I'm Mwalimu, your Socratic mentor for ${subject}. What part of ${subject} would you like to explore today?`
}
