...
See [`README_GIKUYU_TRAINING.md`](./README_GIKUYU_TRAINING.md) for the full Colab walkthrough, expected training time (~30 min on T4), and backend integration steps.
