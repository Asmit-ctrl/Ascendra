...
pub fn all_routes(db: PgPool, cfg: AppConfig) -> Router {
    ...
    let protected = Router::new()
        ...
        .merge(crate::handlers::gamification::router(db.clone(), cfg.clone()))
        .merge(crate::handlers::competency::router(db.clone(), cfg.clone()))
        .merge(crate::handlers::content_gen::router(db.clone(), cfg.clone()))
