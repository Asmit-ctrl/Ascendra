...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            mem0_org_id: String::new(),
            mem0_project_id: String::new(),
...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        Ok(Self {
            ...
            mem0_api_key: std::env::var("MEM0_API_KEY").unwrap_or_default(),
            mem0_org_id: std::env::var("MEM0_ORG_ID").unwrap_or_default(),
            mem0_project_id: std::env::var("MEM0_PROJECT_ID").unwrap_or_default(),
